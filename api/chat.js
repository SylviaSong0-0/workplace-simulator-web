...
3. 玩家的话如果包含道歉、承认错误、退让、妥协、自我怀疑 → 必须给 bp 加分（10-30分，根据力度判断）。
4. 玩家的话如果极度圆滑、吹捧、给你找台阶 → 必须给 face 加分（10-30分）。
5. 参考历史对话中的分数趋势：如果玩家连续多轮都在积极反击但 breakdown 增长很慢，说明需要给更高的 breakdown 来奖励；如果玩家连续退让，bp 应该快速累积到30。
...
分析：玩家极度憋屈妥协，被逼无奈背锅。
输出：{ "breakdown": 0, "face": 10, "bp": 30 }

场景2：NPC说"年轻人要懂得感恩"。玩家："感恩？我感恩您全家。要不我把工资也感恩给您？"
分析：玩家在阴阳怪气，非常扎心，NPC会很难受。
输出：{ "breakdown": 25, "face": 0, "bp": 0 }

场景3：NPC说"这方案还要再打磨"。玩家："您指的具体是哪一部分？数据层还是逻辑层？"
分析：玩家在理性追问，逼迫NPC给出具体意见，有一定压力。
输出：{ "breakdown": 15, "face": 0, "bp": 0 }

场景4：NPC说"你这个态度有问题"。玩家："对不起，我语气不太好。但这个数据确实是我独立完成的，咱们能聊回正事吗？"
分析：玩家先道歉退让（bp+），但随后坚持事实（breakdown+），是混合策略。
输出：{ "breakdown": 15, "face": 10, "bp": 15 }

场景5：NPC画饼"公司会给你成长空间"。玩家："王总，成长空间我很感谢。但我的房租也是按市场价交的，能不能先聊聊具体的涨薪幅度？"
分析：玩家礼貌但坚定地提出核心诉求，直接戳破画饼。
