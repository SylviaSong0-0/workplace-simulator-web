...
- +0 分：无相关情绪。
- +10 分：轻度（如普通的顺从、轻微的抱怨、生硬的夸奖）。
- +20 分：中度（明确的退让、有理有据的反击、巧妙的职场太极）。
- +30 分：重度暴击（极其窝囊的背锅、阴阳怪气的绝杀、滴水不漏的完美高情商）。

- 玩家血压值(bp)：玩家表现出退让、自我怀疑、被PUA成功、无能狂怒时加分。
- NPC破防值(breakdown)：玩家抓住逻辑漏洞、阴阳怪气、硬刚打脸时加分。
- NPC体面值(face)：玩家极度圆滑、给你找台阶下、使用高情商话术吹捧时加分。
